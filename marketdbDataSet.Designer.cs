...
namespace ZGB {
    ...
    public partial class marketdbDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ProductsRow AddProductsRow(int ProductID, string ProductName, string ProductCategory, string ProductCompany, double ProductPrice, int ProductQuantity) {
            ...
            private void InitClass() {
                ...
                this.columnProductCompany.MaxLength = 2147483647;
            }
...
namespace ZGB.marketdbDataSetTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Products] WHERE (([ProductID] = @Original_ProductID) AND ((@IsNull_ProductPrice = 1 AND [ProductPrice] IS NULL) OR ([ProductPrice] = @Original_ProductPrice)) AND ((@IsNull_ProductQuantity = 1 AND [ProductQuantity] IS NULL) OR ([ProductQuantity] = @Original_ProductQuantity)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Products] ([ProductID], [ProductName], [ProductCategory], [ProductCompany], [ProductPrice], [ProductQuantity]) VALUES (@ProductID, @ProductName, @ProductCategory, @ProductCompany, @ProductPrice, @ProductQuantity);
SELECT ProductID, ProductName, ProductCategory, ProductCompany, ProductPrice, ProductQuantity FROM Products WHERE (ProductID = @ProductID)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ProductCategory", global::System.Data.SqlDbType.Text, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ProductCategory", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ProductCompany", global::System.Data.SqlDbType.Text, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ProductCompany", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Products] SET [ProductID] = @ProductID, [ProductName] = @ProductName, [ProductCategory] = @ProductCategory, [ProductCompany] = @ProductCompany, [ProductPrice] = @ProductPrice, [ProductQuantity] = @ProductQuantity WHERE (([ProductID] = @Original_ProductID) AND ((@IsNull_ProductPrice = 1 AND [ProductPrice] IS NULL) OR ([ProductPrice] = @Original_ProductPrice)) AND ((@IsNull_ProductQuantity = 1 AND [ProductQuantity] IS NULL) OR ([ProductQuantity] = @Original_ProductQuantity)));
SELECT ProductID, ProductName, ProductCategory, ProductCompany, ProductPrice, ProductQuantity FROM Products WHERE (ProductID = @ProductID)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ProductCategory", global::System.Data.SqlDbType.Text, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ProductCategory", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ProductCompany", global::System.Data.SqlDbType.Text, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ProductCompany", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ZGB.Properties.Settings.Default.marketdbConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ProductID, ProductName, ProductCategory, ProductCompany, ProductPrice, Pro" +
                "ductQuantity FROM dbo.Products";
        ...
        public virtual int Delete(int Original_ProductID, global::System.Nullable<double> Original_ProductPrice, global::System.Nullable<int> Original_ProductQuantity) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_ProductID));
            if ((Original_ProductPrice.HasValue == true)) {
                this.Adapter.DeleteCommand.Parameters[1].Value = ((object)(0));
                this.Adapter.DeleteCommand.Parameters[2].Value = ((double)(Original_ProductPrice.Value));
            }
            else {
        ...
        public virtual int Insert(int ProductID, string ProductName, string ProductCategory, string ProductCompany, global::System.Nullable<double> ProductPrice, global::System.Nullable<int> ProductQuantity) {
            ...
            if ((ProductQuantity.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[5].Value = ((int)(ProductQuantity.Value));
            }
            else {
        ...
        public virtual int Update(int ProductID, string ProductName, string ProductCategory, string ProductCompany, global::System.Nullable<double> ProductPrice, global::System.Nullable<int> ProductQuantity, int Original_ProductID, global::System.Nullable<double> Original_ProductPrice, global::System.Nullable<int> Original_ProductQuantity) {
            ...
            if ((ProductQuantity.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[5].Value = ((int)(ProductQuantity.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ProductName, string ProductCategory, string ProductCompany, global::System.Nullable<double> ProductPrice, global::System.Nullable<int> ProductQuantity, int Original_ProductID, global::System.Nullable<double> Original_ProductPrice, global::System.Nullable<int> Original_ProductQuantity) {
            return this.Update(Original_ProductID, ProductName, ProductCategory, ProductCompany, ProductPrice, ProductQuantity, Original_ProductID, Original_ProductPrice, Original_ProductQuantity);
        }
    }
